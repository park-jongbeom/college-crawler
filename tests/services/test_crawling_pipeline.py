...
@pytest.mark.unit
def test_pipeline_skips_collector_when_urlfinder_returns_none(schools_list):
    ...
    pipeline = CrawlingPipeline(url_finder=url_finder, collector_cls=collector_cls)
...
@pytest.mark.unit
def test_pipeline_continues_when_collector_raises(schools_list):
...
def test_pipeline_warns_when_no_triples(mock_warning, schools_list):
